  ...
  return (
    <div className=" w-full min-h-screen flex radial2 relative sm:pb-72 pb-64">
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 w-full mt-36 px-3">
        ...
        >
          {/* IMAGE CONTAINER-------------------------------------------------------------------------------------------------------- */}
          <div className="md:w-[800px] w-full barber z-50"></div>
        </m.div>
        ...
        <div className="w-full xl:h-[500px] h-full flex flex-col xl:ml-12 xl:text-start text-center mx-auto relative">
          ...
          <div className=" flex flex-col xl:mx-0 mx-auto my-auto md:w-[575px] w-full">
            ...
            >
              {language ? (
                <div>
                  This website showcases the essence of a modern barbershop
                  steeped in tradition. With a clean, user-friendly design that
                  welcomes visitors to discover your business.
                </div>
              ) : (
                <div>
                  Este sitio web muestra la esencia de una barbería moderna
                  llena de tradición. Con un diseño limpio y fácil de usar que
                  invita a los visitantes a descubrir su negocio.
                </div>
              )}
            </m.div>
