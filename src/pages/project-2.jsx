  ...
  return (
    <div className=" w-full min-h-screen flex radial2 relative sm:pb-72 pb-64">
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 w-full mt-36 px-3">
        ...
        >
          {/* IMAGE CONTAINER-------------------------------------------------------------------------------------------------------- */}
          <div className="md:w-[800px] w-full gleam z-50"></div>
        </m.div>
        ...
        <div className="w-full xl:h-[500px] h-full flex flex-col xl:ml-12 xl:text-start text-center mx-auto relative">
          ...
          <div className=" flex flex-col xl:mx-0 mx-auto my-auto md:w-[575px] w-full">
            ...
            >
              {language ? (
                <div>
                  Gleam AI is a platform that brings together the most popular
                  artificial intelligence tools. Using the OpenAI and
                  ReplicateAI APIs here you can find all the best AIs in one
                  place.
                </div>
              ) : (
                <div>
                  Gleam AI es una plataforma que junta las más populares
                  herramientas de inteligencia artificial. Utilizando APIs de
                  OpenAI y ReplicateAI aquí puedes encontrar las mejores IAs en
                  un solo lugar.
                </div>
              )}
            </m.div>
